...
> Account #0 is the **EU Root Authority** — the blockchain signer configured in all backend services.

⚠️ These are well-known dev accounts. Never use them on any live network.
...
> ⚠️ These addresses reflect the **current deployment** (`blockchain/deployments/latest.json`).
> After any fresh deploy (`forge script` + `docker compose down -v`), re-run `node blockchain/seed-trust-chain.js` and update this table.
> Deployed: 2026-05-10 · Chain ID: 31337

| Contract | Address |
|----------|---------|
| EURootAuthority | `0x5FbDB2315678afecb367f032d93F642f64180aa3` |
| AccreditationRegistry | `0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512` |
| CredentialRegistry | `0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0` |
| ZkpVerifierRegistry | `0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9` |
...
|---------|-----------|---------|
| Romania | #1 | `0x70997970C51812dc3A010C7d01b50e0d17dc79C8` |
| Italy   | #3 | `0x90F79bf6EB2c4f870365E785982E1f101E93b906` |
| UK  | #4 | `0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65` |

### Ministries of Education
| Country | Account # | Address |
|---------|-----------|---------|
| Romania | #2 | `0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC` |
| Italy   | #5 | `0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc` |
| UK  | #6 | `0x976EA74026e726554dB657fA54763abd0C3a0aa9` |

### Universities
| University | Country | Account # | Address |
|------------|---------|-----------|---------|
| UAIC       | Romania | #7 | `0x14dC79964da2C08b23698B3D3cc7Ca32193d9955` |
| Sapienza   | Italy   | #8 | `0x23618e81E3f5cdF7f54C3d65f7FBc0aBf5B21E8f` |
| Cambridge University | UK | #9 | `0xa0Ee7A142d267C1f36714E4a8F75612F20a79720` |
