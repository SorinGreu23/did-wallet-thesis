    ...
    const renderIdentity = () => {
        ...
        const canAdvance =
            accountType === 'personal'
                ? state.firstName.trim() && state.lastName.trim() && hasValidEmail
                : state.legalName.trim() && hasValidEmail &&
    ...
    const handlePollEnterpriseApproval = async () => {
        ...
        try {
            ...
            if (data.status === 'Approved') {
                const id = data.accreditationId ||
                    await accreditationLookupService.findActiveEnterpriseAccreditation(identity.walletAddress);
        ...
        try {
            ...
            if (accountType === 'personal') {
                ...
                if(!finalAccreditationId) {
                    throw new Error('Missing institution accreditation. Please complete the accreditation step first.')
                }
                ...
                if(!finalAccreditationId) {
                    throw new Error('Missing enterprise accreditation. Please complete the approval step first.')
                }
